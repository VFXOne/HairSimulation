...
public:
    ...
    CRConstraint(Index numVertices, Scalar weight)
...
public:
    ...
    StretchShearConstraint(Index num_coord, Scalar weight, Index pos_index, Scalar quat_index, Scalar segment_length)
...
public:
    ...
    BendTwistConstraint(Index num_coord, Scalar weight, Index quat_index)
    : CRConstraint(num_coord, weight) {
        q_index = quat_index;
